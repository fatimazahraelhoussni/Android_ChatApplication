...
import com.example.chatapplication.databinding.ItemContainerRecievedMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ChatAdapter(List<ChatMessage> chatMessages, String sendId, Bitmap receiverProfileImage) {
