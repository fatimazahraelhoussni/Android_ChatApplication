...
public class SignUpActivity extends AppCompatActivity {
  ...
  private String encodeImage;
    ...
    private final ActivityResultLauncher<Intent> pichImage = registerForActivityResult(
    ...
    private Boolean isValidSinUpDetails() {
        if (encodeImage == null) {
